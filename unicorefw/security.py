...
def validate_type(value: Any, expected_types: Union[Type, Tuple[Type, ...]], param_name: str = "parameter") -> Any:
    """
...
def sanitize_string(value: Any, max_length: Optional[int] = None, allowed_chars: Optional[str] = None) -> str:
    """
